...
func.dependencies = [
  'BridgeAssistTransferUpgradeable.deploy, BridgeAssistCircleMintUpgradeable.deploy, BridgeAssistNativeUpgradeable.deploy, BridgeAssistMintUpgradeable.deploy',
]
