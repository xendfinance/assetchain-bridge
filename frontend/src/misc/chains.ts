...
export const REAL_CHAIN_IDS: ChainId[] = IS_PROD ? ['97', '421614', '42421', '11155111', '80002', '84532'] : ['97', '421614', '42421']

export const chainsLabels: { value: ChainId; label: string; component: any }[] = IS_PROD
  ? [
