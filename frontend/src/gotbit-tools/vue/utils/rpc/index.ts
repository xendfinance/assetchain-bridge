import { ChainTag, RemoteChainTag, RpcFunction } from '../misc'
import { extraRpcs } from '../node'
...
export const ankrRpc = (): RpcFunction => {
  ...
  return (chainTag: ChainTag) => {
    ...
    if (chainTag === 'arbitrum_sepolia') return 'https://endpoints.omniatech.io/v1/arbitrum/sepolia/public'
    if (chainTag === 'xend_testnet') return 'https://data-seed-prebsc-1-s1.binance.org:8545/'
...
export const toRealChainTag = (chainTag: ChainTag) => {
  return import.meta.env.VITE_MODE ? chainTag + '_' + import.meta.env.VITE_MODE : chainTag
}
