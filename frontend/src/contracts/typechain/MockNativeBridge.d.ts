...
interface MockNativeBridgeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "afterSend(address,address,uint256,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "afterSend", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "eip712Domain",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "FeeFulfillSet(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "FeeFulfillSet"): EventFragment;
...
export type FeeFulfillSetEvent = TypedEvent<
  [BigNumber] & { feeFulfill: BigNumber }
>;
...
export class MockNativeBridge extends BaseContract {
  ...
  interface: MockNativeBridgeInterface;
  ...
  setLimitPerSend(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "FeeFulfillSet(uint256)"(
      feeFulfill?: null
    ): TypedEventFilter<[BigNumber], { feeFulfill: BigNumber }>;
