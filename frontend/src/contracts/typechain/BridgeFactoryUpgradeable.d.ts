...
interface BridgeFactoryUpgradeableInterface extends ethers.utils.Interface {
  functions: {
    "ADD_REMOVE_LIMIT_PER_TIME()": FunctionFragment;
    "CREATOR_ROLE()": FunctionFragment;
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "addBridgeAssists(address[])": FunctionFragment;
    "bridgeAssistImplementation(uint8)": FunctionFragment;
    "changeBridgeAssistImplementation(address,address,address)": FunctionFragment;
    "createBridgeAssist(uint8,address,uint256,address,uint256,uint256,address,address[],uint256)": FunctionFragment;
  ...
  events: {
    ...
    "BridgeAssistImplementationsSet(address,address,address)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "BridgeAssistImplementationsSet"
  ): EventFragment;
...
export type BridgeAssistImplementationsSetEvent = TypedEvent<
...
export class BridgeFactoryUpgradeable extends BaseContract {
  ...
  interface: BridgeFactoryUpgradeableInterface;
  ...
  functions: {
    ...
    changeBridgeAssistImplementation(
      bridgeAssistTransferImplementation_: string,
      bridgeAssistMintImplementation_: string,
      bridgeAssistNativeImplementation_: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "BridgeAssistImplementationsSet(address,address,address)"(
      bridgeTransfer?: string | null,
      bridgeMint?: string | null,
      bridgeNative?: string | null
    ): TypedEventFilter<
      [string, string, string],
      { bridgeTransfer: string; bridgeMint: string; bridgeNative: string }
    >;
